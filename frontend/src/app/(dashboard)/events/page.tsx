...
import { EventFilters, type EventFiltersValues } from "@/components/features/events/EventFilters"
...
export default function EventsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <EventFilters values={filters} onChange={handleFiltersChange} onClear={handleClearFilters} />

      <EventList params={mergedParams} onPageChange={handlePageChange} />
    </div>
  )
}
