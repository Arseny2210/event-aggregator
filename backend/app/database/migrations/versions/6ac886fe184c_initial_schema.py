...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "channel",
            sa.Enum(
                "email", "telegram", "in_app", name="notificationchanneltype", native_enum=False
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "draft", "published", "completed", "archived", name="eventstatus", native_enum=False
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("processing", "completed", "failed", name="importstatus", native_enum=False),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "priority",
            sa.Enum(
                "LOW", "NORMAL", "HIGH", "CRITICAL", name="notificationpriority", native_enum=False
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("imported", "warning", "failed", name="importrowstatus", native_enum=False),
            nullable=False,
        ),
